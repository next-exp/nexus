...
namespace nexus {
  ...
  CylinderVertexGenerator::CylinderVertexGenerator(G4double inner_radius,
  ...
  CylinderVertexGenerator::~CylinderVertexGenerator()
  {
  }
  
  
  
  G4ThreeVector CylinderVertexGenerator::GenerateVertex(const G4String& region)
  {
    G4double x, y, z;
    ...
    // Unknown region
      ...
      G4Exception("[CylinderVertexGenerator] ERROR: Unknown region!");
    }
  }



  G4double CylinderVertexGenerator::GetRadius(G4double inner, G4double outer) 
  {
    G4double rand = G4UniformRand();
  ...
  G4double CylinderVertexGenerator::GetPhi() 
  {
  ...
  G4double CylinderVertexGenerator::GetLength(G4double origin, G4double max_length) 
  {
  ...
  G4ThreeVector CylinderVertexGenerator::RotateAndTranslate(G4ThreeVector position) 
  {
