// ----------------------------------------------------------------------------
///  \file   BoxVertexGenerator.h
///  \brief  Generator of random points in a box-shaped volume.
///
...
#ifndef __BOX_VERTEX_GENERATOR__
#define __BOX_VERTEX_GENERATOR__
...
namespace nexus {
  ...
  /// Generator of random points in a box-shaped volume.

  class BoxVertexGenerator
  {
  public:
    /// Constructor
    BoxVertexGenerator(G4double inner_x, G4double inner_y, G4double inner_z, 
		       G4double _thickness,
