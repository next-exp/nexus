...
namespace nexus {
  ...
  /// by the NexusFactory is set in the WORLD. This class owns the 
  /// geometry instance and takes care of deleting it at the end of the run.
  ...
  public:
    ...
    /// Mandatory method invoked by the G4RunManager. It must
    /// return the physical volume that represents the world.
    G4VPhysicalVolume* Construct();

    /// Set a detector geometry
    void SetGeometry(BaseGeometry*);
    /// Get the detector geometry
    const BaseGeometry* GetGeometry();
  ...
  inline const BaseGeometry* DetectorConstruction::GetGeometry()
  { return _geometry; }
