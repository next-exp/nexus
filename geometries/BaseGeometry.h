...
namespace nexus {
  ...
  {
  public:
    /// Returns logical volume representing the geometry
  ...
  protected:
    /// Constructor (defined as protected so no instance of this base
    /// class can be created).
    BaseGeometry();

    /// Set logical volume representing the geometry
    void SetLogicalVolume(G4LogicalVolume*);

    /// Set the span (maximum dimension) of the geometry
