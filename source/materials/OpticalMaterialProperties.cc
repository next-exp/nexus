...
// wavelenth of 270 nm is 100 nm, which is hard to believe comparing with
...
// XXX No se porqué la funcion de arriba (el primer sumando) no reproduce bien
// la gaussiana corregida, así que cogemos el del TPB
...
//                   WLS_emiSpectrum, WLS_emi_entries);
  ...
  // WLS Quantum Efficiency
  // XXX The QE of TPB depends on the incident wavelength.
  // As G4 doesn't contemplate this possibility, we set it to
  // the value corresponding to Xe scintillation light.
  mpt->AddConstProperty("WLSMEANNUMBERPHOTONS", 0.65);
