...
G4MaterialPropertiesTable* OpticalMaterialProperties::PTFE()
{
  ...
  G4double REFLECTIVITY[REFL_NUMENTRIES] = {1., 1.};
...
;
 ...
 G4double WLS_Energies[wls_numentries] = {1.*eV, 2.8*eV, 4.*eV, 5.*eV, 5.2*eV, 5.4*eV, 5.6*eV, 5.9*eV, 6.2*eV, 6.5*eV, 6.9*eV, 7.3*eV, 7.7*eV, 8.3*eV};
 G4double TPB_ConvEfficiency[wls_numentries] = {0., 0., 0., .87, .90, .94, .90, .80, .75, 0.71, .75, .82, .85, .93};
