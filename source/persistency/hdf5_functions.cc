...
hsize_t createEventType()
{
  ...
  H5Tinsert (memtype, "evt_id", HOFFSET (evt_t, evt_id), H5T_NATIVE_INT32);
...
hsize_t createSensorDataType()
{
  ...
  H5Tinsert (memtype, "evt_id", HOFFSET (sns_data_t, evt_id), H5T_NATIVE_INT32);
...
hsize_t createSensorTofType()
{
  ...
  H5Tinsert (memtype, "evt_id", HOFFSET (sns_tof_t, evt_id), H5T_NATIVE_INT32);
...
{  
  ...
  H5Tinsert (memtype, "evt_id", HOFFSET (hit_info_t, evt_id), H5T_NATIVE_INT32);
  H5Tinsert (memtype, "hit_pos_x",HOFFSET (hit_info_t, hit_pos_x), H5T_NATIVE_FLOAT);
  H5Tinsert (memtype, "hit_pos_y",HOFFSET (hit_info_t, hit_pos_y), H5T_NATIVE_FLOAT);
  H5Tinsert (memtype, "hit_pos_z",HOFFSET (hit_info_t, hit_pos_z), H5T_NATIVE_FLOAT);
...
hsize_t createParticleInfoType()
{
  ...
  H5Tinsert (memtype, "evt_id", HOFFSET (particle_info_t, evt_id), H5T_NATIVE_INT32);
  ...
  H5Tinsert (memtype, "initial_vertex_x",HOFFSET (particle_info_t, initial_vertex_x), H5T_NATIVE_FLOAT);
  H5Tinsert (memtype, "initial_vertex_y",HOFFSET (particle_info_t, initial_vertex_y), H5T_NATIVE_FLOAT);
  H5Tinsert (memtype, "initial_vertex_z",HOFFSET (particle_info_t, initial_vertex_z), H5T_NATIVE_FLOAT);
  H5Tinsert (memtype, "initial_vertex_t",HOFFSET (particle_info_t, initial_vertex_t), H5T_NATIVE_FLOAT);
  H5Tinsert (memtype, "final_vertex_x",HOFFSET (particle_info_t, final_vertex_x), H5T_NATIVE_FLOAT);
  H5Tinsert (memtype, "final_vertex_y",HOFFSET (particle_info_t, final_vertex_y), H5T_NATIVE_FLOAT);
  H5Tinsert (memtype, "final_vertex_z",HOFFSET (particle_info_t, final_vertex_z), H5T_NATIVE_FLOAT);
  H5Tinsert (memtype, "final_vertex_t",HOFFSET (particle_info_t, final_vertex_t), H5T_NATIVE_FLOAT);
  ...
  H5Tinsert (memtype, "momentum_x",HOFFSET (particle_info_t, momentum_x), H5T_NATIVE_FLOAT);
  H5Tinsert (memtype, "momentum_y",HOFFSET (particle_info_t, momentum_y), H5T_NATIVE_FLOAT);
  H5Tinsert (memtype, "momentum_z",HOFFSET (particle_info_t, momentum_z), H5T_NATIVE_FLOAT);
