...
namespace nexus {
  ...
  G4VPhysicalVolume* DetectorConstruction::Construct()
  {
    ...
    // WORLD is a big box (proportional to the geometry span) "filled" 
    // with galactic vacuum
    ...
    G4PVPlacement* geometry_physi = 
      new G4PVPlacement(0, G4ThreeVector(0,0,0), geometry_logic, 
			geometry_logic->GetName(), world_logic, false, 0);
