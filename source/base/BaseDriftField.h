...
///  \brief  Abstract base class for describing drift fields.
///  
...
namespace nexus {
  ...
  public:
    ...
    virtual G4LorentzVector Drift(const G4LorentzVector&, DriftTrackInfo*) = 0;

    /// Returns a random 4D point (space and time) along a drift line
    virtual 
    G4LorentzVector GeneratePointAlongDriftLine(const G4LorentzVector&) = 0;
