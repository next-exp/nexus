...
namespace nexus {
  ...
  G4ThreeVector CylinderVertexGenerator::GenerateVertex(CylinderRegion region)
  {
    switch (region) {
  ...
  G4double CylinderVertexGenerator::GetLength(G4double origin, 
					      G4double max_length) 
  {
  ...
  G4ThreeVector 
  CylinderVertexGenerator::RotateAndTranslate(G4ThreeVector position) 
  {
