...
void PDF::sample(double &x, double r){
  if (dim!= 1){
    G4Exception("", "", FatalException, "The histogram is not 1D");}
  if ((r < 0) || (r>1)){
...
void PDF::sample(double &x, double &y, double r1, double r2){
  if (dim != 2){
    G4Exception("", "", FatalException, "The histogram is not 2D");}
...
void PDF::sample(double &x, double &y, double &z, double r1, double r2, double r3){
  if (dim != 3){
    G4Exception("", "", FatalException, "The histogram is not 3D");}
