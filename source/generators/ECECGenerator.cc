...
G4AtomicShellEnumerator ECECGenerator::GetShellID(G4String shell)
{
       if (shell == "K" ) return fKShell;
  else if (shell == "L1") return fL1Shell;
  else if (shell == "L2") return fL2Shell;
  else if (shell == "L3") return fL3Shell;
  else if (shell == "M1") return fM1Shell;
  else if (shell == "M2") return fM2Shell;
  else if (shell == "M3") return fM3Shell;
  else if (shell == "M4") return fM4Shell;
  else if (shell == "M5") return fM5Shell;
  else
