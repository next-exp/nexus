...
namespace nexus {
  ...
  void PetitKDB::Construct()
  {
    ...
    const G4double out_z = board_thickness + sipm_z_dim;
    ...
    new G4PVPlacement(0, G4ThreeVector(0.,0., -out_z/2.+board_thickness/2.), board_logic,
    ...
    */
    ...
    G4double pos_z = - out_z/2. + board_thickness + sipm_z_dim/2.;
