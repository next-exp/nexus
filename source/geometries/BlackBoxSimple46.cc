...
namespace nexus {
  ...
  BlackBoxSimple46::BlackBoxSimple46():
    _world_z (2. * m),
    _world_xy (1. *m),
    ...
    _visibility(0)
  {
    _msg = new G4GenericMessenger(this, "/Geometry/BlackBoxSimple46/",
  ...
  void BlackBoxSimple46::Construct()
  {
  // WORLD /////////////////////////////////////////////////
  ...
  // VISIBILITIES ///////////////////////////////////////////////////
    ...
    G4ThreeVector BlackBoxSimple46::GenerateVertex(const G4String& region) const
  {
    ...
    //}
      ...
      G4Exception("[BlackBoxSimple46]", "GenerateVertex()", FatalException,
  ...
  G4OpticalSurface* BlackBoxSimple46::GetPhotOptSurf() 
  {
