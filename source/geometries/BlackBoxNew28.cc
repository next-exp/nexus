...
namespace nexus {
  ...
  BlackBoxNew28::BlackBoxNew28():
    ...
    _visibility(0)
  {
    _msg = new G4GenericMessenger(this, "/Geometry/BlackBoxNew28/",
  ...
  // VISIBILITIES ///////////////////////////////////////////////////
    ...
    G4ThreeVector BlackBoxNew28::GenerateVertex(const G4String& region) const
  {
    ...
    if (region == "WORLD") {
      ...
      G4Exception("[BlackBoxNew28]", "GenerateVertex()", FatalException,
  ...
  G4OpticalSurface* BlackBoxNew28::GetPhotOptSurf() 
  {
