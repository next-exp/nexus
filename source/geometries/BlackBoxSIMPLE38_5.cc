...
namespace nexus {
  ...
  BlackBoxSIMPLE38_5::BlackBoxSIMPLE38_5():
    _world_z (2. * m),
    _world_xy (1. *m),
    ...
    _visibility(0)
  {
    _msg = new G4GenericMessenger(this, "/Geometry/BlackBoxSIMPLE38_5/",
  ...
  void BlackBoxSIMPLE38_5::Construct()
  {
  // WORLD /////////////////////////////////////////////////
  ...
  // VISIBILITIES ///////////////////////////////////////////////////
    ...
    G4ThreeVector BlackBoxSIMPLE38_5::GenerateVertex(const G4String& region) const
  {
    ...
    //}
      ...
      G4Exception("[BlackBoxSIMPLE38_5]", "GenerateVertex()", FatalException,
  ...
  G4OpticalSurface* BlackBoxSIMPLE38_5::GetPhotOptSurf() 
  {
