...
namespace nexus {
  ...
  BlackBoxNEW26_5::BlackBoxNEW26_5():
    _world_z (2. * m),
    _world_xy (1. *m),
    ...
    _visibility(0)
  {
    _msg = new G4GenericMessenger(this, "/Geometry/BlackBoxNEW26_5/",
  ...
  void BlackBoxNEW26_5::Construct()
  {
  // WORLD /////////////////////////////////////////////////
  ...
  // VISIBILITIES ///////////////////////////////////////////////////
    ...
    G4ThreeVector BlackBoxNEW26_5::GenerateVertex(const G4String& region) const
  {
    ...
    if (region == "WORLD") {
      ...
      G4Exception("[BlackBoxNEW26_5]", "GenerateVertex()", FatalException,
  ...
  G4OpticalSurface* BlackBoxNEW26_5::GetPhotOptSurf() 
  {
