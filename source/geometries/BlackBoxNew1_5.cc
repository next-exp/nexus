...
namespace nexus {
  ...
  BlackBoxNew1_5::BlackBoxNew1_5():
    ...
    _visibility(0)
  {
    _msg = new G4GenericMessenger(this, "/Geometry/BlackBoxNew1_5/",
  ...
  // VISIBILITIES ///////////////////////////////////////////////////
    ...
    G4ThreeVector BlackBoxNew1_5::GenerateVertex(const G4String& region) const
  {
    ...
    if (region == "WORLD") {
      ...
      G4Exception("[BlackBoxNew1_5]", "GenerateVertex()", FatalException,
  ...
  G4OpticalSurface* BlackBoxNew1_5::GetPhotOptSurf() 
  {
