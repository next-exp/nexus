...
namespace nexus {
  ...
  BlackBoxSIMPLE28::BlackBoxSIMPLE28():
    _world_z (2. * m),
    _world_xy (1. *m),
    ...
    _visibility(0)
  {
    _msg = new G4GenericMessenger(this, "/Geometry/BlackBoxSIMPLE28/",
  ...
  void BlackBoxSIMPLE28::Construct()
  {
  // WORLD /////////////////////////////////////////////////
  ...
  // VISIBILITIES ///////////////////////////////////////////////////
    ...
    G4ThreeVector BlackBoxSIMPLE28::GenerateVertex(const G4String& region) const
  {
    ...
    //}
      ...
      G4Exception("[BlackBoxSIMPLE28]", "GenerateVertex()", FatalException,
  ...
  G4OpticalSurface* BlackBoxSIMPLE28::GetPhotOptSurf() 
  {
