...
namespace nexus {
  ...
  BlackBoxSimple53_5::BlackBoxSimple53_5():
    _world_z (2. * m),
    _world_xy (1. *m),
    ...
    _visibility(0)
  {
    _msg = new G4GenericMessenger(this, "/Geometry/BlackBoxSimple53_5/",
  ...
  void BlackBoxSimple53_5::Construct()
  {
  // WORLD /////////////////////////////////////////////////
  ...
  // VISIBILITIES ///////////////////////////////////////////////////
    ...
    G4ThreeVector BlackBoxSimple53_5::GenerateVertex(const G4String& region) const
  {
    ...
    //}
      ...
      G4Exception("[BlackBoxSimple53_5]", "GenerateVertex()", FatalException,
  ...
  G4OpticalSurface* BlackBoxSimple53_5::GetPhotOptSurf() 
  {
