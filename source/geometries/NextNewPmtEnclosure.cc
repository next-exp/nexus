...
namespace nexus{
  ...
  void NextNewPmtEnclosure::Construct()
  {
    ...
    G4double gas_length = _enclosure_length - _enclosure_endcap_thickness/2 -
    ...
    _gas_pos = (_enclosure_endcap_thickness/2-_enclosure_window_thickness-
     	          _enclosure_pad_thickness)/2;
    new G4PVPlacement(nullptr, G4ThreeVector(0.,0.,_gas_pos), enclosure_gas_logic,
    ...
    new G4PVPlacement(nullptr, G4ThreeVector(0.,0.,_window_z_pos),
    ...
    G4double tpb_coating_zpos = _enclosure_window_thickness/2. - tpb_coating_thickn/2.;
    ...
    G4double pedot_coating_zpos =
      _enclosure_window_thickness/2. - tpb_coating_thickn - pedot_coating_thickn/2.;
    ...
    G4Tubs* enclosure_pad_solid =
      new G4Tubs("OPTICAL_PAD", 0., _enclosure_in_diam/2.,
                 _enclosure_pad_thickness/2.,0.,twopi);
    ...
    new G4PVPlacement(nullptr, G4ThreeVector(0.,0.,_pmt_z_pos), pmt_logic,
    ...
    G4LogicalVolume* pmt_base_logic =
      new G4LogicalVolume(pmt_base_solid,
                          ...
                          "PMT_BASE");
    new G4PVPlacement(nullptr, G4ThreeVector(0.,0., -_pmt_base_z),
