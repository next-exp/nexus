...
namespace nexus {
  ...
  {
    // Messenger
    msg_ = new G4GenericMessenger(this, "/Geometry/PetalX4/", "Control commands of geometry PetalX4.");
 ...
 void PetalX4::BuildLXe() 
  ...
  G4ThreeVector PetalX4::GenerateVertex(const G4String& region) const
  {
