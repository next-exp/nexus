...
namespace nexus {
  ...
  BlackBoxSimple26_5::BlackBoxSimple26_5():
    _world_z (2. * m),
    _world_xy (1. *m),
    ...
    _visibility(0)
  {
    _msg = new G4GenericMessenger(this, "/Geometry/BlackBoxSimple26_5/",
  ...
  void BlackBoxSimple26_5::Construct()
  {
  // WORLD /////////////////////////////////////////////////
  ...
  // VISIBILITIES ///////////////////////////////////////////////////
    ...
    G4ThreeVector BlackBoxSimple26_5::GenerateVertex(const G4String& region) const
  {
    ...
    //}
      ...
      G4Exception("[BlackBoxSimple26_5]", "GenerateVertex()", FatalException,
  ...
  G4OpticalSurface* BlackBoxSimple26_5::GetPhotOptSurf() 
  {
