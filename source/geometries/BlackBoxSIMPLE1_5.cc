...
namespace nexus {
  ...
  BlackBoxSIMPLE1_5::BlackBoxSIMPLE1_5():
    _world_z (2. * m),
    _world_xy (1. *m),
    ...
    _visibility(0)
  {
    _msg = new G4GenericMessenger(this, "/Geometry/BlackBoxSIMPLE1_5/",
  ...
  void BlackBoxSIMPLE1_5::Construct()
  {
  // WORLD /////////////////////////////////////////////////
  ...
  // VISIBILITIES ///////////////////////////////////////////////////
    ...
    G4ThreeVector BlackBoxSIMPLE1_5::GenerateVertex(const G4String& region) const
  {
    ...
    //}
      ...
      G4Exception("[BlackBoxSIMPLE1_5]", "GenerateVertex()", FatalException,
  ...
  G4OpticalSurface* BlackBoxSIMPLE1_5::GetPhotOptSurf() 
  {
