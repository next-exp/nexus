...
namespace nexus {
  ...
  BlackBoxSIMPLE3_5::BlackBoxSIMPLE3_5():
    _world_z (2. * m),
    _world_xy (1. *m),
    ...
    _visibility(0)
  {
    _msg = new G4GenericMessenger(this, "/Geometry/BlackBoxSIMPLE3_5/",
  ...
  void BlackBoxSIMPLE3_5::Construct()
  {
  // WORLD /////////////////////////////////////////////////
  ...
  // VISIBILITIES ///////////////////////////////////////////////////
    ...
    G4ThreeVector BlackBoxSIMPLE3_5::GenerateVertex(const G4String& region) const
  {
    ...
    //}
      ...
      G4Exception("[BlackBoxSIMPLE3_5]", "GenerateVertex()", FatalException,
  ...
  G4OpticalSurface* BlackBoxSIMPLE3_5::GetPhotOptSurf() 
  {
