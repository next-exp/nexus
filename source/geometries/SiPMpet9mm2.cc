...
namespace nexus {
  ...
  SiPMpet9mm2::SiPMpet9mm2(): BaseGeometry(),
			    visibility_(0),
			    refr_index_(1.54),
                            eff_(1.),
  ...
  SiPMpet9mm2::~SiPMpet9mm2()
  {
  }  
  
  void SiPMpet9mm2::Construct()
  {
   
    // PACKAGE ///////////////////////////////////////////////////////
    
    // Hamamatsu 3X3MM-50UM 9mm2
    G4double sipm_x = 6.5* mm;
    G4double sipm_y = 6.5 * mm;
    G4double sipm_z = 1.50 * mm; // 1.55 * mm;
    ...
    new G4PVPlacement(0, G4ThreeVector(0., 0., sipm_z/2. - active_depth/2. - .1*mm),
    ...
    G4String sdname = "/SIPM/SiPMpet9mm2";
