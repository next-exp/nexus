...
namespace nexus {
  ...
  BlackBoxNew46::BlackBoxNew46():
    ...
    _visibility(0)
  {
    _msg = new G4GenericMessenger(this, "/Geometry/BlackBoxNew46/",
  ...
  // VISIBILITIES ///////////////////////////////////////////////////
    ...
    G4ThreeVector BlackBoxNew46::GenerateVertex(const G4String& region) const
  {
    ...
    if (region == "WORLD") {
      ...
      G4Exception("[BlackBoxNew46]", "GenerateVertex()", FatalException,
  ...
  G4OpticalSurface* BlackBoxNew46::GetPhotOptSurf() 
  {
