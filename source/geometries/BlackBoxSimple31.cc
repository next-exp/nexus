...
namespace nexus {
  ...
  BlackBoxSimple31::BlackBoxSimple31():
    _world_z (2. * m),
    _world_xy (1. *m),
    ...
    _visibility(0)
  {
    _msg = new G4GenericMessenger(this, "/Geometry/BlackBoxSimple31/",
  ...
  void BlackBoxSimple31::Construct()
  {
  // WORLD /////////////////////////////////////////////////
  ...
  // VISIBILITIES ///////////////////////////////////////////////////
    ...
    G4ThreeVector BlackBoxSimple31::GenerateVertex(const G4String& region) const
  {
    ...
    //}
      ...
      G4Exception("[BlackBoxSimple31]", "GenerateVertex()", FatalException,
  ...
  G4OpticalSurface* BlackBoxSimple31::GetPhotOptSurf() 
  {
