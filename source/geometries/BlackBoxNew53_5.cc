...
namespace nexus {
  ...
  BlackBoxNew53_5::BlackBoxNew53_5():
    _world_z (2. * m),
    _world_xy (1. *m),
    ...
    _visibility(0)
  {
    _msg = new G4GenericMessenger(this, "/Geometry/BlackBoxNew53_5/",
  ...
  void BlackBoxNew53_5::Construct()
  {
  // WORLD /////////////////////////////////////////////////
  ...
  // VISIBILITIES ///////////////////////////////////////////////////
    ...
    G4ThreeVector BlackBoxNew53_5::GenerateVertex(const G4String& region) const
  {
    ...
    if (region == "WORLD") {
      ...
      G4Exception("[BlackBoxNew53_5]", "GenerateVertex()", FatalException,
  ...
  G4OpticalSurface* BlackBoxNew53_5::GetPhotOptSurf() 
  {
