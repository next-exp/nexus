...
Next100InnerElements::Next100InnerElements(G4LogicalVolume* mother_logic):
  ...
  _cath_grid_transparency (.98)
{
  ...
  G4PVPlacement*   field_logic_physi = new G4PVPlacement(0, field_cage_pos, field_cage_logic,
  							 "FIELD_CAGE", mother_logic, false, 0);
  ...
  // Energy Plane
  _energy_plane = new Next100EnergyPlane(mother_logic);
...
void Next100InnerElements::ReadParameters()
{
  ...
  _grids_visibility = cfg_geom.GetIParam("grids_vis");

}



void Next100InnerElements::GetMaterials()
{
