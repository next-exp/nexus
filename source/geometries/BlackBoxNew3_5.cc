...
namespace nexus {
  ...
  BlackBoxNew3_5::BlackBoxNew3_5():
    ...
    _visibility(0)
  {
    _msg = new G4GenericMessenger(this, "/Geometry/BlackBoxNew3_5/",
  ...
  // VISIBILITIES ///////////////////////////////////////////////////
    ...
    G4ThreeVector BlackBoxNew3_5::GenerateVertex(const G4String& region) const
  {
    ...
    if (region == "WORLD") {
      ...
      G4Exception("[BlackBoxNew3_5]", "GenerateVertex()", FatalException,
  ...
  G4OpticalSurface* BlackBoxNew3_5::GetPhotOptSurf() 
  {
