...
namespace nexus {
  ...
  BlackBoxNew38_5::BlackBoxNew38_5():
    _world_z (2. * m),
    _world_xy (1. *m),
    ...
    _visibility(0)
  {
    _msg = new G4GenericMessenger(this, "/Geometry/BlackBoxNew38_5/",
  ...
  void BlackBoxNew38_5::Construct()
  {
  // WORLD /////////////////////////////////////////////////
  ...
  // VISIBILITIES ///////////////////////////////////////////////////
    ...
    G4ThreeVector BlackBoxNew38_5::GenerateVertex(const G4String& region) const
  {
    ...
    if (region == "WORLD") {
      ...
      G4Exception("[BlackBoxNew38_5]", "GenerateVertex()", FatalException,
  ...
  G4OpticalSurface* BlackBoxNew38_5::GetPhotOptSurf() 
  {
