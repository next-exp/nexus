...
namespace nexus {
  ...
  BlackBoxSIMPLE23_5::BlackBoxSIMPLE23_5():
    _world_z (2. * m),
    _world_xy (1. *m),
    ...
    _visibility(0)
  {
    _msg = new G4GenericMessenger(this, "/Geometry/BlackBoxSIMPLE23_5/",
  ...
  void BlackBoxSIMPLE23_5::Construct()
  {
  // WORLD /////////////////////////////////////////////////
  ...
  // VISIBILITIES ///////////////////////////////////////////////////
    ...
    G4ThreeVector BlackBoxSIMPLE23_5::GenerateVertex(const G4String& region) const
  {
    ...
    //}
      ...
      G4Exception("[BlackBoxSIMPLE23_5]", "GenerateVertex()", FatalException,
  ...
  G4OpticalSurface* BlackBoxSIMPLE23_5::GetPhotOptSurf() 
  {
