...
namespace nexus {
  ...
  BlackBoxNew23_5::BlackBoxNew23_5():
    _world_z (2. * m),
    _world_xy (1. *m),
    ...
    _visibility(0)
  {
    _msg = new G4GenericMessenger(this, "/Geometry/BlackBoxNew23_5/",
  ...
  void BlackBoxNew23_5::Construct()
  {
  // WORLD /////////////////////////////////////////////////
  ...
  // VISIBILITIES ///////////////////////////////////////////////////
    ...
    G4ThreeVector BlackBoxNew23_5::GenerateVertex(const G4String& region) const
  {
    ...
    if (region == "WORLD") {
      ...
      G4Exception("[BlackBoxNew23_5]", "GenerateVertex()", FatalException,
  ...
  G4OpticalSurface* BlackBoxNew23_5::GetPhotOptSurf() 
  {
