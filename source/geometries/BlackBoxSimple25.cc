...
namespace nexus {
  ...
  BlackBoxSimple25::BlackBoxSimple25():
    _world_z (2. * m),
    _world_xy (1. *m),
    ...
    _visibility(0)
  {
    _msg = new G4GenericMessenger(this, "/Geometry/BlackBoxSimple25/",
  ...
  void BlackBoxSimple25::Construct()
  {
  // WORLD /////////////////////////////////////////////////
  ...
  // VISIBILITIES ///////////////////////////////////////////////////
    ...
    G4ThreeVector BlackBoxSimple25::GenerateVertex(const G4String& region) const
  {
    ...
    //}
      ...
      G4Exception("[BlackBoxSimple25]", "GenerateVertex()", FatalException,
  ...
  G4OpticalSurface* BlackBoxSimple25::GetPhotOptSurf() 
  {
